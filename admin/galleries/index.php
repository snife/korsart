		...
		<form method="post">
			...
			<?php
				if(!empty($_REQUEST['c'])) {
					echo "
						<br /><br />
						<input type='button' id='gallerySubmit' value='Новая галерея' onmouseover='buttonHover(\"gallerySubmit\", 1)' onmouseout='buttonHover(\"gallerySubmit\", 0)' onclick='window.location.href = \"/admin/galleries/add.php\"' class='button' />
					";
				}
			?>
		</form>
